...
<html class="no-js" lang="pt-BR">
	<head>
		...
		<link media="all" type="text/css" href="./assets/vendor/metro-ui/metro-ui-css/2.0.31/min/metro-bootstrap.min.css" rel="stylesheet">
		<script src="./assets/vendor/jquery/1.10.2/jquery.min.js?ver=1.10.2" type="text/javascript"></script>
		<script src="./assets/vendor/jquery-ui/1.10.4/js/jquery-ui-1.10.4.custom.min.js" type="text/javascript"></script>
		<script src="./assets/vendor/metro-ui/metro-ui-css/2.0.31/min/metro.min.js" type="text/javascript"></script>
	</head>
	<body class="metro">
		<h1>METRO UI</h1>
		<hr/>
